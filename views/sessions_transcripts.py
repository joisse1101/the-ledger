...
from views.sessions_context import (
    _maybe_render_transcript_dialog,
    _open_transcript_dialog,
)
from views.sessions_table import (_ROW_CSS, _format_context, _render_sortable_table_header,
                                  _render_table_row, _tooltip_text)


_TRANSCRIPTS_COLUMNS = ["Project", "Title", "Session ID", "Started", "Last Updated", "Messages", "Cost ($)", "Context", "Version", "Git Branch"]
    ...
    with st.container(gap="xxsmall"):
        ...
        for row in df.to_dict("records"):
            ...
            _render_table_row(
                ...
                on_click=lambda r=row: _open_transcript_dialog(
